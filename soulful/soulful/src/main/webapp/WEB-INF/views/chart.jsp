      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-active-primary">
			...
			<ul class="nav" data-ui-nav>
				...
				<li>
				  <a data-toggle="modal" data-target="#search-modal5">
					<span class="nav-icon">
					  <i class="material-icons">
						search
					  </i>
    ...
    <div class="col-lg-9 b-r no-border-md">
      <div class="padding">
        ...
        <div class="page-title m-b">
          <h1 class="inline m-a-0">Top 10</h1>
          <div class="dropdown inline">
            <button class="btn btn-sm no-bg h4 m-y-0 v-b dropdown-toggle text-primary" data-toggle="dropdown">지난 주</button>
...
<!-- ############ PAGE END-->
  ...
  <!-- ############ SWITHCHER END-->
  <!-- ############ SEARCH START -->
  <div class="modal white lt fade" id="search-modal5" data-backdrop="false">
